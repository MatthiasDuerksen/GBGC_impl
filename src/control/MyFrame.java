...
//     * @param graph current graph of the new step of the compression.
...
//     */
//    public synchronized void refreshGraph(model.Graph.Graph graph, String text, Tuple<List<Node>, List<Edge>> markedElements, BasicDigram_old nextDigram) {
//        graph.clear();
//        displayGraph(graph);
...
//     */
//    private void displayGraph(Graph hyperGraph) {
